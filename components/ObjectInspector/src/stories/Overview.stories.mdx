...
<Title>@iampava-devtools-ds/object-inspector</Title>
...
You can use the `onSelect` prop to get the `@iampava-devtools-ds/object-parser` AST node for the currently selected part of the object.
